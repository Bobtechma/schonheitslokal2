...
BEGIN
    ...
    -- Actually, if we are looking at "Most Sold", created_at might be better, but "Most Booked" usually implies popularity for attendance.
    -- Let's keep appointment_date for congruence with "Appointments" count.
