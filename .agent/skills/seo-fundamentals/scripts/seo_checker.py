...
SKIP_DIRS = {
    ...
    'antigravity-awesome-skills-main', 'frontend_flutter'
}
...
def check_page(file_path: Path) -> dict:
    ...
    # Detect if this is a layout/template file (has Head component or metadata or head tag)
    has_next_meta = 'export const metadata' in content or 'export const generateMetadata' in content
    is_layout = 'Head>' in content or bool(re.search(r'<head\b', content, re.IGNORECASE)) or has_next_meta
