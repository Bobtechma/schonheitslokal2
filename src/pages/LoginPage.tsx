...
export default function LoginPage() {
  ...
  const { signIn, signInWithGoogle, isAuthenticated, isLoading, error, clearError } = useAuthStore()
  ...
  useEffect(() => {
    if (isAuthenticated) {
      ...
      const from = location.state?.from?.pathname ||
        (user?.role === 'admin' || user?.role === 'owner' ? '/admin/dashboard' : '/meus-agendamentos')
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Greifen Sie auf Ihr Konto zu, um Ihre Termine zu verwalten
          </p>
        </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full flex justify-center items-center py-3 px-4 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
              >
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">
            ...
            <Link
              to="/cliente/cadastro"
              className="font-medium text-pink-600 hover:text-pink-500 inline-flex items-center"
            >
