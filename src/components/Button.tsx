...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        // Updated to pink #c55b9f to match logo
        primary: "bg-[#c55b9f] hover:bg-[#a44a83] text-white focus:ring-[#c55b9f] shadow-lg shadow-[#c55b9f]/20",
        secondary: "bg-zinc-800 hover:bg-zinc-700 text-white border border-zinc-700 focus:ring-zinc-500",
        outline: "bg-transparent border border-zinc-600 text-zinc-300 hover:border-[#c55b9f] hover:text-[#c55b9f]",
        ghost: "bg-transparent text-zinc-400 hover:text-[#c55b9f] hover:bg-[#c55b9f]/10",
